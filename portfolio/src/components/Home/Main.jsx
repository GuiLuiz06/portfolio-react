  ...
  return (
    <>
      ...
      <div>
        ...
        codigo={"https://github.com/GuiLuiz06/Project-Liquida-Games"}
        />
      </div>
      ...
      <div className="bg-lime-300">
        ...
        {/* estou tentando adicionar um guia para a proxima pagina(projetos) mas nao esta ficando rolavel a tela, fica embaixo do nav*/}
    </>
  );
}
